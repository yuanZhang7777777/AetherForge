...
export default function Dashboard() {
  ...
  if (workspace.isLoading) return <Shell><PageHeading eyebrow="运营工作台" title="正在读取工作台…" /></Shell>;
